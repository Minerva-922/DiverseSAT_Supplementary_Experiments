"""
CPLEX IW (Increasing Weights, unary) encoding + SEv3 standalone.

Linear objective with the unary U_{j,r} counting chain, plus SEv3
(see ``materials/14-symmetry_elimination.pdf`` Version 3) as the
sole symmetry-breaking block.  SEv1 is NOT added.
"""
