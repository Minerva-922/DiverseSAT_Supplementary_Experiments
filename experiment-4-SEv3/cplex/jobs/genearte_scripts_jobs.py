#!/usr/bin/env python3
"""
Generate SLURM job scripts for experiment-4 CPLEX runs.

experiment-4 scope:
    k in {2, 3, 4, 5, 10}
    encodings in {QP, DW, IW, BIN}
    symmetry mode fixed to SEv3 standalone
    solver fixed to CPLEX
"""
...
def main():
    ...
    with open(submission_script, "w") as f:
        ...
        f.write("# experiment-4 CPLEX submission (SEv3 standalone)\n")
