#!/usr/bin/env python3
"""
UNA diversity encoding + SEv3-alone symmetry elimination (no SEv1).
See ``OH_SEv3_cnf_to_PBO.py`` for the header-level description.
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="python UNA_SEv3_cnf_to_PBO.py <in.cnf> <out.opb> <K>"
    )
