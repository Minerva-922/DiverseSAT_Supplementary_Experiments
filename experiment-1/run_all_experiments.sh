...
sumup_results() {
    ...
    python sumup.py || warn "RoundingSAT sumup encountered errors (results may be incomplete)."

    echo ""
    log "Aggregating CPLEX results..."
    cd "$SCRIPT_DIR/cplex/sumup"
    python sumup.py || warn "CPLEX sumup encountered errors (results may be incomplete)."
